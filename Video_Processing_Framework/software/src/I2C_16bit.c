...
#define DeviceId	XPAR_XIICPS_0_DEVICE_ID
...
int I2C_config_init(void)
{
	...
	while(ov_5640_config_table[i].addr != Config_done)
	{
		I2C_write(&Iic,ov_5640_config_table[i].addr,ov_5640_config_table[i].data);
		i++;
	}
